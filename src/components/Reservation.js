  ...
  return(
    <div style={{backgroundImage: `url(${Reservationbg})`}} className="bg-cover bg-center bg-no-repeat">
      ...
      <div className="w-full h-full flex flex-col justify-center items-center gap-12">
        ...
        <p className="text-white max-w-[500px] text-center sm:px-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, repudiandae. Itaque fugiat totam nam laborum.</p>
