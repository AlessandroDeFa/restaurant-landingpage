  ...
  return(
    <header className="p-4">
      <div className="grid grid-cols-3 max-w-[95%] my-0 mx-auto lg:flex lg:justify-between">
        ...
        <div ref={navbar} className="grid place-content-center md:absolute md:w-full md:left-0 md:top-[87px] md:block  origin-top md:transition-transform md:duration-300 md:z-10 md:scale-y-0">
