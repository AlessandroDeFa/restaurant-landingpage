  ...
  return (
    <div className="h-screen bg-[#140e11] flex flex-col justify-evenly overflow-x-hidden">
      ...
      <div className="w-full h-full flex md:flex-col">
        ...
        <Link to="/menu" id="btn" className="group-hover:opacity-[1] group-hover:transition-opacity group-hover:duration-700 opacity-0 delay-200 hover:bg-[#e4ccc0] transition duration-400 w-52 h-12 bg-[#f8b984] text-sm text-black font-semibold uppercase bg-[#f8b984] text-center w-60 h-12 flex justify-center items-center"> See Menu <img src="" alt="" /></Link>
        </div>
