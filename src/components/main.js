...
const Main = ()=> {
  return (
    <div id="About" className="min-h-screen bg-[#140e11] justify-evenly flex flex-col">
      <div className="text-[#d1d0d1] text-xl max-w-[90%] pt-4 border-t-[1px] border-[#f8b984]  mx-auto w-screen ">INTRODUCTION</div>
      <div className="max-w-[90%] my-0 mx-auto w-screen h-[100%] flex">
        ...
        <div className="w-1/2 h-full">
          <div className="pl-16 flex flex-col gap-12 h-full justify-evenly">
            ...
            <div className="flex justify-start items-center"><a href="" className="hover:bg-[#e4ccc0] transition duration-400 w-60 h-12 bg-[#f8b984] text-sm text-black font-semibold uppercase bg-[#f8b984] text-center w-60 h-12 flex justify-center items-center"> See More <img src="" alt="" /></a></div>
          </div>
          </div>
          </div>
      </div>
